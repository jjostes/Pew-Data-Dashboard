...
layout = dbc.Container([
    ...
    html.Ul(
        html.Li(
            dcc.Link('Pew Research Center, American Trends Panel 42', href='https://www.pewresearch.org/science/dataset/american-trends-panel-wave-42/')
        )
    ),
    ...
    html.Ul([
        html.Li(
            dcc.Link('Most Americans are wary of industry-funded research', href='https://tinyurl.com/y2ywl8l3')
        ),
